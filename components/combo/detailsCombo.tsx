          ...
          <div className="col-12 col-md-7">
            <div className="p-3 border-bottom">
              {loading ? (
                ...
                <>
                    <h3 className="text-center p-1 text-cici"><span role="img">💟</span> {combo.name} <span role="img">💕</span></h3>  
                    <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Dignissimos eaque mollitia nemo repellendus eius distinctio atque fuga a ullam qui, blanditiis recusandae quo voluptas quae cupiditate officiis eum quam iusto!</p>
                </>
              )}
              <div className="row">
                <div
                  ...
                  loading ? (
                    ...
                    <div className="row">
                        <div className="col-12 p-3 text-center mt-3">
                            <h3>Productos de <strong>{combo.name}</strong></h3>
                        </div>

                      {combo.products.map((product) => (
                        <div className="col-12 border-bottom" key={product.idProducts}>
                          <Link href={`/productos/${product.idProducts}`}>
                                <a href={`/productos/${product.idProducts}`} target="_blank" style={{ textDecoration: 'none', color: '#4b4a4a' }}>
